...
// /*       // 配置默认项 token user 等
 ...
 //       $rootScope.secret = '123321';
    		...
    		U.setStorage('api_url',"http://xcx.zhuodeguang.top/");
        U.setStorage('ApiInterfaceUrl',"http://xcx.zhuodeguang.top/app/api/");
       $rootScope.urlPrefix = 'http://xcx.zhuodeguang.top/app/api/';
